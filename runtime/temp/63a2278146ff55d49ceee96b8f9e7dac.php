<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\wamp\www\dingdang\public/../application/admin\view\enroll\index.html";i:1511517166;s:72:"C:\wamp\www\dingdang\public/../application/admin\view\public\header.html";i:1510456974;s:69:"C:\wamp\www\dingdang\public/../application/admin\view\public\nav.html";i:1512123514;s:72:"C:\wamp\www\dingdang\public/../application/admin\view\public\footer.html";i:1510456924;}*/ ?>
<!DOCTYPE html>
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">报名管理</h4>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                <?php if(is_array($enroll) || $enroll instanceof \think\Collection || $enroll instanceof \think\Paginator): $i = 0; $__LIST__ = $enroll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo $vo['id']; ?></td>
                        <td><?php echo $vo['user_id']['name']; ?></td>
                        <td><?php echo $vo['lecture_id']['title']; ?></td>
                        <td>
...
<script>
    var URL = {
        'status_url' : '__URL__admin/enroll/setStatus',
        'success_url' : '__URL__admin/enroll/index'
    };
</script>
