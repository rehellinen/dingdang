<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"C:\wamp\www\dingdang\public/../application/beta\view\index\index.html";i:1513003690;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <img src="__STATIC__/img/code.jpg" class="img-responsive">
        </div>
    </div>
</div>
...
<div class="container">
    <h4>注意事项：</h4>
    <p>1. 口令可以生成四位数抽奖码，四位数抽奖码可以生成五位数抽奖码，所有抽奖码均有机会赢取各类奖品（演唱会门票、电影票、红包、美食券...）。</p>
