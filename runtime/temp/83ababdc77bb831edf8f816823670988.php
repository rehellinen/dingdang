...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">添加讲座</h4>
            </div>
        </div>
        <div class="container">
            <form id="submitForm" method="post" enctype="multipart/form-data" class="form-signin form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="time" id="time" placeholder="格式为2017-11-11 12:24:00">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea name="detail" class="form-control" id="detail" placeholder="请填写详情" rows="5"></textarea>
                    </div>
                </div>
