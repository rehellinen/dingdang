...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">讲座管理</h4>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                <?php if(is_array($lecture) || $lecture instanceof \think\Collection || $lecture instanceof \think\Paginator): $i = 0; $__LIST__ = $lecture;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
...
<script>
    var URL = {
        'status_url' : '__URL__admin/lecture/setStatus',
        'success_url' : '__URL__admin/lecture/index',
        'add_url' : '__URL__admin/lecture/add',
        'edit_url' : '__URL__admin/lecture/edit'
