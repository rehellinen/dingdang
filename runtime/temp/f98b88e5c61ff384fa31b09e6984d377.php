<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"C:\wamp\www\dingdang\public/../application/admin\view\place\add.html";i:1510402347;s:72:"C:\wamp\www\dingdang\public/../application/admin\view\public\header.html";i:1510456974;s:69:"C:\wamp\www\dingdang\public/../application/admin\view\public\nav.html";i:1510888433;s:72:"C:\wamp\www\dingdang\public/../application/admin\view\public\footer.html";i:1510456924;}*/ ?>
<!DOCTYPE html>
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">添加地点</h4>
            </div>
        </div>
        ...
        <div class="container">
            <form id="submitForm" method="post" enctype="multipart/form-data" class="form-signin form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="name" id="name" placeholder="请填写地点">
                    </div>
                </div>

                <div class="form-group">
                    <label for="max" class="col-sm-2 control-label">最大容量:</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="max" id="max" placeholder="请填写最大容量">
                    </div>
                </div>
...
<script>
    var URL = {
        'success_url' : '__URL__admin/place/index',
        'add_url' : '__URL__admin/place/add'
    };
</script>
