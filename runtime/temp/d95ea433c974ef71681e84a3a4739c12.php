<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"C:\wamp\www\dingdang\public/../application/admin\view\place\edit.html";i:1510403966;s:72:"C:\wamp\www\dingdang\public/../application/admin\view\public\header.html";i:1510456974;s:69:"C:\wamp\www\dingdang\public/../application/admin\view\public\nav.html";i:1510888433;s:72:"C:\wamp\www\dingdang\public/../application/admin\view\public\footer.html";i:1510456924;}*/ ?>
<!DOCTYPE html>
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">编辑地点</h4>
            </div>
        </div>
        ...
        <div class="container">
            <form id="submitForm" method="post" enctype="multipart/form-data" class="form-signin form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="max" id="max" value="<?php echo $res['max']; ?>">
                    </div>
                </div>
...
<script>
    var URL = {
        'submit_url' : '__URL__admin/place/edit',
